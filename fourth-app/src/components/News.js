...
export class News extends Component {
  ...
  //     "title": "2024 WWE Royal Rumble results, recap, grades: Cody Rhodes eliminates CM Punk last, Bayley wins first Rumble - CBS Sports",
  ...
  async componentDidMount() {
    let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=dab0f9b4b8574e2b9ad482360fe4f7c8&page=1&pageSize=20";
  ...
  handleNextClick = async () => {
    if(this.state.page+1> Math.ceil(this.state.totalResults/20)){
      ...
      let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=dab0f9b4b8574e2b9ad482360fe4f7c8&page=${this.state.page + 1}&pageSize=20`;
      let data = await fetch(url);
      let parsedData = await data.json();
      this.setState({
        articles: parsedData.articles,
