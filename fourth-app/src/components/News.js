...
export class News extends Component {
  ...
  async updateNews(){
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=dab0f9b4b8574e2b9ad482360fe4f7c8&page=${this.state.page}&pageSize=${this.props.pageSize}`;
